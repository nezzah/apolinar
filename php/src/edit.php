...
<?php
            if(isset($_POST['edit_btn'])){
                ...
                $query = "SELECT * FROM personal_journal WHERE id ='$id' ";
        ...
        ?>
                        ...
                        <form role="form" action="crud.php" method="POST">
                            <input type="hidden" name ="edit_id" value="<?php echo $row['id']; ?>">
                                        ...
                                        <input type="text" name="title" class="form-control" id="usr" style="text-transform: capitalize;" value="<?php echo $row['title']; ?>">
                                        </div>

                                        <div class="form-group">
                                        <label for="usr">note:</label>
                                        <input type="text" name="note" class="form-control" id="usr" style="text-transform: capitalize;" value="<?php echo $row['note']; ?>">
                                        </div>
